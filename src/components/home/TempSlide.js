...
function TempSlide({ image, text }) {
  ...
  return (
    <div
      ...
      className="w-[6.8rem] h-[5.56rem] rounded-[1.25rem] flex items-center justify-center shadow-[-10px_-10px_20px_#FFFFFF,10px_10px_20px_#D3E7F7]"
    >
      <div
      ...
      >
        <img
          ...
          alt="appointment"
        ></img>
        <p className="font-[700] px-1 text-[0.75rem] leading-[0.93rem] text-[#4D478B] text-center">
          {text}
        </p>
      </div>
    </div>
