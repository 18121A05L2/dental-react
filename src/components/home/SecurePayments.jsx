...
function SecurePayments() {
  return (
    <div className="absolute bottom-0 bg-[#2B275A] -right-[1.56rem] -left-[1.56rem] p-1 ">
      ...
      <img className=" absolute bottom-0 right-[7rem]    w-[10rem]" src="/home/p1.png" alt="payment"></img>
      <img className="absolute top-0 right-0  w-[10rem]" src="/home/p2.png" alt="payment"></img>
    </div>
  );
}
