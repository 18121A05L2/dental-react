...
function Consultation() {
  ...
  const styles = {
    div: "flex justify-center flex-col  max-w-[10.8rem] h-[7.8rem] rounded-[1.9rem]  items-center shadow-[10px_10px_20px_0px_#D3E7F6,-10px_-10px_20px_0px_#FFFFFF] cursor-pointer",
    p: "m-2 font-[900] text-[0.81rem] ",
    left: " bg-red-500 bg-[linear-gradient(130.06deg,#ACA4FE_0%,#5C55AB_35.33%,#2B275A_75.68%)] rounded-l-[3.75rem] rounded-r-[1.9rem]",
    right:
      " bg-[linear-gradient(130.06deg,#ACA4FE_0%,#5C55AB_35.33%,#2B275A_75.68%)] rounded-r-[3.75rem] rounded-l-[1.9rem]",
  };
  return (
