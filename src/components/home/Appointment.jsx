  ...
  return (
    <div className="appointment_section">
      ...
      <div className={styles.div}>
        ...
        <input className={styles.input} placeholder="Age*" />
      </div>
      <div className={styles.div}>
        <img
          ...
          alt="consultation"
        ></img>
        <input className={styles.input} placeholder="consultaion*" />
      </div>
      <div className={styles.div}>
        <img
          className={styles.image}
      ...
      <div className="w-[23rem] h-[3.56rem] flex justify-center items-center bg-[linear-gradient(130.06deg,#ACA4FE_0%,#5C55AB_35.33%,#2B275A_75.68%)] shadow-[-10px_-10px_20px_0px_#FFFFFF,10px_10px_20px_4px_#D2E1ED] rounded-full ">
