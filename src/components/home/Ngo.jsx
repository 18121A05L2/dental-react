...
function Ngo({ text, icon }) {
  const [isClicked, setIsClicked] = useState(false);
  return (
    <div className="w-[10.9rem]  h-[13.2rem] rounded-[1.9rem]   shadow-[10px_10px_20px_0px_#D3E7F6,-10px_-10px_20px_0px_#FFFFFF] flex flex-col justify-between items-center">
