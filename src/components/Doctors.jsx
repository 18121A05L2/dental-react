    ...
    <div className="doctor_section">
      <div className=" flex justify-around ">
        <img
          ...
          alt="homedoctor"
        ></img>
        <div className="w-[7.25rem] h-[13.12rem]  rounded-[1.88rem] flex flex-col justify-center items-center gap-[1.25rem] font-['Kumbh_Sans'] text-center ds font-[800] leading-[0.63rem] text-[0.63rem]">
          <span>
            <p>3+</p>
            <p>Years Exp</p>
          </span>
      ...
      <div className="flex justify-around">
        ...
        <section className="w-[8.5rem]  h-[3.9rem] rounded-l-[1.25rem] rounded-r-[1.88rem] flex items-center justify-center bg-[linear-gradient(130.06deg,#ACA4FE_0%,#5C55AB_35.33%,#2B275A_75.68%)]">
