      ...
      >
        {arr.map((src, index) => (
          <div className="inline-block">
            <Review key={index} image={src} />
          </div>
        ))}
      </div>
      <div className="flex mt-8 rounded-full justify-around items-center m-auto w-[2.2rem] h-[0.7rem] shadow-[inset_-1px_-1px_2px_#FFFFFF,inset_1px_1px_2px_#D3E0EB]">
        <div
          className={` ${
            index === 0 ? "bg-black" : ""
